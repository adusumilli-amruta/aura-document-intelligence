...
from watchservice.watcher import FolderWatcher, WatchEvent, Event
...
class FolderWatcherService:
    """Manages folder monitoring lifecycle and auto-ingestion."""
    ...
    def _process_events(self):
        """Background thread that processes queued file events."""
