...
class EmbeddingManager:
    """Manages SentenceTransformer model loading and embedding generation."""
    ...
    def generate_embedding(self, chunks: List[DocumentChunk]) -> List[List[float]]:
    ...
    def generate_query_embedding(self, query: List[str]) -> List[float]:
