...
class ExactMatchSearch:
    """Exact phrase and word-level matching."""
...
class RRF:
    ...
    def combine_rankings(self,
        ...
        if weights is None:
            weights = {'semantic': 1.0, 'keyword': 1.0, 'exact': 2.0}
...
class HybridSearch:
    """Orchestrates semantic, keyword, and exact-match search with RRF fusion."""
    ...
    def build_keyword_index(self, force_rebuild: bool = False):
        """Build the BM25 keyword index from all documents in Qdrant."""
    ...
    def hybrid_search(self,
                      ...
                      search_filter: Optional[Dict] = None) -> List[SearchResult]:
    ...
    def _semantic_search(self, query: str, top_k: int,
                         search_filter: Optional[Dict]) -> List[Tuple[str, float]]:
        try:
    ...
    def _build_final_results(self,
        ...
        """Build SearchResult objects with individual score breakdowns."""
