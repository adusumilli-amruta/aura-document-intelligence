...
class Pipeline:
    ...
    def index_directory(self, skip_existing: bool = True) -> dict:
        """Index all documents in the base directory."""
    ...
    def _process_single_file(self, idx: int, file_path: Union[Path, str],
                              total_files: int, skip_existing: bool) -> dict:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--base_directory", type=str, required=True,
                        help="Base directory containing documents to index")
    ...
    parser.add_argument("--skip_existing", action="store_true",
                        help="Skip files that are already indexed")
