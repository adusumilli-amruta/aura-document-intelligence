...
class FileHandler:
    ...
    def get_all_files(self) -> List[Path]:
        """Discover all files with allowed extensions recursively."""
        files = []
    ...
    def extract_text_from_file(self, file_path: str) -> Optional[str]:
        """Extract text from a document using the unstructured library."""
        try:
    ...
    def compute_hash(file_path: str) -> str:
        """Compute a fast hash based on file size and modification time."""
